					...
					<div class="home_container">
						<div class="home_container_inner d-flex flex-column align-items-center justify-content-center">
							<div class="home_content text-center">
								<div class="home_subtitle">New single release</div>
								<div class="home_title"><h1>Love is all around</h1></div>
								<div class="home_link"><a href="#">Listening Now</a></div>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="featured_album_player">
							<div class="featured_album_title_bar d-flex flex-row align-items-center justify-content-start">
								<div class="featured_album_title_container">
									...
									<div class="featured_album_title">Music is all around, just listen with your heart</div>
								</div>
								<div class="featured_album_link ml-auto"><a href="#">Get Premium</a></div>
							</div>
		...
		<div class="container">
			<div class="row" style="z-index:10;">
				<div class="col">
					<div class="section_title_container">
						<div class="section_subtitle">Songs</div>
						<div class="section_title"><h1>Upcoming Songs</h1></div>
					</div>
				</div>
			</div>
						...
						<ul class="shows_list">
							...
							<li class="d-flex flex-row align-items-center justify-content-start">
								...
								<div class="show_info d-flex flex-md-row flex-column align-items-md-center align-items-start justify-content-md-start justify-content-center">
									<div class="show_name"><a href="#">TOO MUCH</a></div>
									<div class="show_location"></div>
								</div>
								<div class="ml-auto"><div class="show_shop trans_200"><a href="#">Add Library</a></div></div>
							</li>
							...
							<li class="d-flex flex-row align-items-center justify-content-start">
								...
								<div class="show_info d-flex flex-md-row flex-column align-items-md-center align-items-start justify-content-md-start justify-content-center">
									<div class="show_name"><a href="#">In The City</a></div>
									<div class="show_location"></div>
								</div>
								<div class="ml-auto"><div class="show_shop trans_200"><a href="#">Add Library</a></div></div>
							</li>
							...
							<li class="d-flex flex-row align-items-center justify-content-start">
								...
								<div class="show_info d-flex flex-md-row flex-column align-items-md-center align-items-start justify-content-md-start justify-content-center">
									<div class="show_name"><a href="#">Dreaming</a></div>
									<div class="show_location"></div>
								</div>
								<div class="ml-auto"><div class="show_shop trans_200"><a href="#">Add Library</a></div></div>
							</li>
							...
							<li class="d-flex flex-row align-items-center justify-content-start">
								...
								<div class="show_info d-flex flex-md-row flex-column align-items-md-center align-items-start justify-content-md-start justify-content-center">
									<div class="show_name"><a href="#">Mess It Up</a></div>
									<div class="show_location"></div>
								</div>
								<div class="ml-auto"><div class="show_shop trans_200"><a href="#">Add Library</a></div></div>
							</li>
							...
							<li class="d-flex flex-row align-items-center justify-content-start">
								...
								<div class="show_info d-flex flex-md-row flex-column align-items-md-center align-items-start justify-content-md-start justify-content-center">
									<div class="show_name"><a href="#">Think of Us</a></div>
									<div class="show_location"></div>
								</div>
								<div class="ml-auto"><div class="show_shop trans_200"><a href="#">Add Library</a></div></div>
							</li>
							...
							<li class="d-flex flex-row align-items-center justify-content-start">
								...
								<div class="show_info d-flex flex-md-row flex-column align-items-md-center align-items-start justify-content-md-start justify-content-center">
									<div class="show_name"><a href="#">Friend of Mine</a></div>
									<div class="show_location"></div>
								</div>
								<div class="ml-auto"><div class="show_shop trans_200"><a href="#">Add Library</a></div></div>
							</li>
